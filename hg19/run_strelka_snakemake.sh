...
PREFIX="multicentric_snake"
#SNAKE_FILE="oncotator_annotation.snakemake"

SNAKE_FILE="strelka_variant_calling.snakemake.py"
...
#snakemake -s $SNAKE_FILE --cluster-config cluster.json --drmaa " -q all.q -cwd -V -b y -j y -l {cluster.hvmem} -l {cluster.memrequested}" -j 200
